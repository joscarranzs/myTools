...
public class MyConsole {
    ...
    /**
     * Method to clean the console, it works on linux and windows.
     * @return The MyConsole object.
     */

    public MyConsole cleanLine() {
        try {
            if (System.getProperty("os.name").toLowerCase().contains("windows")) {
                new ProcessBuilder("cmd", "/c", "cls").inheritIO().start().waitFor();
            } else {
    ...
    public MyConsole print(String message) {
    ...
    public MyConsole print(String[] messages) {
    ...
    /**
     * Prints a single object to the console.
     *
    ...
    public <T> MyConsole print(T message) {
        System.out.println(message);
        return this;
    }

    /**
     * Prints a message and a list of objects to the console.
     *
     * @param message The message to print.
    ...
    public <T> MyConsole print(String message, List<T> list) {
        System.out.println(message);
        for (T element : list) {
